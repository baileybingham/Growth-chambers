...
tomst24<- read.csv(("Calculating growth chamber parameters/data/QHI temperature data/TOMST data/QHI_location_temperature_daily_2024.csv"))
tomst25<- read.csv(("Calculating growth chamber parameters/data/QHI temperature data/TOMST data/QHI_location_temperature_daily_2025.csv"))
